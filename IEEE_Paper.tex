...
\begin{figure}[htbp]
  ...
  \caption{Qualitative inference example from the project supplementary demo artifact, showing zone-wise interpretation and final ABO/Rh decision generation.}
  \label{fig:ai_output}
\end{figure}
