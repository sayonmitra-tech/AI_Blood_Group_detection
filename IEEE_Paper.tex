...
\begin{figure}[htbp]
  ...
  Asset included in the project repository supplementary visual materials.}}
...
\begin{itemize}
  \item The following metadata were not explicitly logged in archived training notebook records: GPU, TensorFlow version, CUDA/cuDNN version, and total training time.
