...
\begin{figure}[htbp]
  ...
  \textbf{Provided AI prediction screenshot placeholder.} Insert the user-provided live inference screenshot from:\\
  \url{https://github.com/user-attachments/assets/bfb29d08-fee4-4fdc-885a-824b686b6f5b}}}
  \caption{Example live inference output showing Anti-A/Anti-B/Anti-D zone predictions and final blood-group decision.}
  \label{fig:ai_output}
\end{figure}
...
To support reproducible reporting, the following training metadata should be documented in final camera-ready submission:
\begin{itemize}
  \item GPU: \textbf{[to be filled]}
  \item TensorFlow version: \textbf{[to be filled]}
  \item CUDA/cuDNN version: \textbf{[to be filled]}
  \item Total training time: \textbf{[to be filled]}
